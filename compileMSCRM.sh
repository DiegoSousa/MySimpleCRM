...
javac -d target/classes/ -sourcepath src/main/java/:threadControl_0.3_src/srcTC/ -cp :$HOME/.m2/repository/javax/javaee-web-api/6.0/javaee-web-api-6.0.jar:$HOME/.m2/repository/com/sun/jersey/jersey-json/1.8/jersey-json-1.8.jar:$HOME/.m2/repository/org/codehaus/jettison/jettison/1.1/jettison-1.1.jar $(find src/main/ threadControl_0.3_src/srcTC/ -name *.java)

echo ""
echo "compiling *.java (tests)"
javac -d target/classes/ -sourcepath src/main/java/:threadControl_0.3_src/srcTC/ -cp :$HOME/.m2/repository/junit/junit/4.8.2/junit-4.8.2.jar:$HOME/.m2/repository/javax/javaee-web-api/6.0/javaee-web-api-6.0.jar $(find src/test/ -name *.java)
...
ajc -d target/classes/ -source 1.6 -cp :$HOME/.m2/repository/org/aspectj/aspectjrt/1.7.2/aspectjrt-1.7.2.jar:target/classes/ threadControl_0.3_src/srcAspectsTC/br/edu/ufcg/threadcontrol/aspects/ThreadControlAspect.aj 2> /dev/null
